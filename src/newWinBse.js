...
function getBTC() {
    ...
    //         price.innerHTML = '$'+cryptos.toLocaleString('en')
            ...
            request('https://www.quandl.com/api/v3/datasets/BSE/SPBSN5IP.json?api_key=knVzs43rSuvCx7oV9ryE', function(error, response, body){
   ...
   var sensexValBefore0 = body.dataset.data[0][1];
 ...
 document.getElementById('priceGold').innerHTML = sensexValBefore0.toLocaleString('en')+ " INR";
    const CHART3 = document.getElementById("GoldChartLine")
    ...
    let sensexChart = new Chart(CHART3, {
        ...
        data: {
            ...
            datasets: [{
                ...
                // data: [12, 19, 3, 5, 2, 3],
                data: [sensexValBefore5, sensexValBefore4, sensexValBefore3,sensexValBefore2, sensexValBefore1, sensexValBefore0],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
     ...
     const ChartBtc2 = document.getElementById('GoldChartBar');
